...
=for HTML <a href="https://www.github.com/briandfoy/text-multimarkdown/actions?query=workflow%3Amacos"><img src="https://www.github.com/briandfoy/text-multimarkdown/workflows/macos/badge.svg"></a>

=for HTML <a href="https://www.github.com/briandfoy/text-multimarkdown/actions?query=workflow%3Aubuntu"><img src="https://www.github.com/briandfoy/text-multimarkdown/workflows/ubuntu/badge.svg"></a>

=for HTML <a href="https://www.github.com/briandfoy/text-multimarkdown/actions?query=workflow%3Awindows"><img src="https://www.github.com/briandfoy/text-multimarkdown/workflows/windows/badge.svg"></a>

=for HTML <a href='https://ci.appveyor.com/project/briandfoy/text-multimarkdown'><img src='https://ci.appveyor.com/api/projects/status/gbh4ev5m9hjdtknp' /></a>

=for HTML <a href='https://coveralls.io/github/briandfoy/text-multimarkdown?branch=master'><img src='https://coveralls.io/repos/github/briandfoy/text-multimarkdown/badge.svg?branch=master' alt='Coverage Status' /></a>

=for HTML <a href="https://github.com/briandfoy/text-multimarkdown/blob/master/LICENSE"><img src="https://img.shields.io/cpan/l/Text-MultiMarkdown.svg" /></a>

=for HTML <a href="https://metacpan.org/pod/Text:MultiMarkdown"><img src="https://img.shields.io/cpan/v/Text-MultiMarkdown.svg" /></A>

=head1 The Text::MultiMarkdown module

This is the I<README> for the L<Text::MultiMarkdown> Perl module. It allows
you to convert Markdown, with extensions, to either HTML or XHTML.
...
the source repository: L<https://github.com/briandfoy/text-multimarkdown>

If you find a problem, file a ticket in the L<issue
tracker|https://github.com/briandfoy/text-multimarkdown/issues>.
...
=item * L<https://bitbucket.com/briandfoy/text-multimarkdown>

=item * L<https://codeberg.org/briandfoy/text-multimarkdown>

=item * L<https://gitlab.com/briandfoy/text-multimarkdown>
...
You need a GitHub account and the L<gh tool|https://github.com/larsks/ghcli>.
	...
	$ gh auth login
	...follow instructions...
	$ gh attestation verify Text-MultiMarkdown-1.23.tar.gz --owner briandfoy
